...
public class TestRefurbishedStore {
	...
	public void test_refurbished_store_1() {
		...
		Entry e1 = new Entry("F9FND4NKQ1GC",p1);
	...
	public void test_refurbished_store_2() {
		...
		assertTrue(rs.getProduct("F9FND4NKQ1GC") == p1);
		...
		assertEquals(929.00,rs.getProduct("7YM4PFZ779UB").getOriginalPrice(),0.0);
		assertEquals(0.0,rs.getProduct("7YM4PFZ779UB").getDiscountValue(),0.0);
		...
		assertTrue(rs.getProduct("7YM4PFZ779UB").hasCellularConnectivity() == false);
		assertEquals(929.00,rs.getProduct("7YM4PFZ779UB").getOriginalPrice(),0.0);
		assertEquals(270.0,rs.getProduct("7YM4PFZ779UB").getDiscountValue(),0.0);
	...
	public void test_refurbished_store_3() {
		...
		assertTrue(
				rs.getSpaceGreyOrPro()[0].equals("F9FND4NKQ1GC") && 
				rs.getSpaceGreyOrPro()[1].equals("7YM4PFZ779UB")
				);
		assertTrue(rs.getSpaceGreyPro().length == 1);
		assertTrue(rs.getSpaceGreyPro()[0].equals("F9FND4NKQ1GC"));
	}
}
