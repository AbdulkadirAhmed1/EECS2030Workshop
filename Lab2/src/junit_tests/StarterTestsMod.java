...
public class StarterTestsMod {
	...
	@Test
	public void mod_test_vaccine_01() {
		/* 
		 ...
		 */ 
		Vaccine v1 = new Vaccine("mRNA-1273", "RNA", "@1 Moderna");
		Vaccine v2 = new Vaccine("BNT162b2", "RNA", "@2 Pfizer/BioNTech");
		Vaccine v3 = new Vaccine("Ad26.COV2.S", "Non Replicating Viral Vector", "@3 Janssen");
		Vaccine v4 = new Vaccine("AZD1222", "Non Replicating Viral Vector", "@4 Oxford/AstraZeneca");

		assertEquals("Recognized vaccine: mRNA-1273 (RNA; @1 Moderna)", v1.toString());
		assertEquals("Recognized vaccine: BNT162b2 (RNA; @2 Pfizer/BioNTech)", v2.toString());
		assertEquals("Recognized vaccine: Ad26.COV2.S (Non Replicating Viral Vector; @3 Janssen)", v3.toString());
		assertEquals("Recognized vaccine: AZD1222 (Non Replicating Viral Vector; @4 Oxford/AstraZeneca)", v4.toString());
	}

	@Test
	public void mod_test_vaccine_02() {
		/* 
		 ...
		 * See Section 2.3 of the lab manual for the list of recognized vaccines. 
		 */ 
		Vaccine v5 = new Vaccine("Covishield", "Non Replicating Viral Vector", "@1 Serum Institute of India");
		Vaccine v6 = new Vaccine("BBIBP-CorV", "Inactivated", "@2 Sinopharm");
		Vaccine v7 = new Vaccine("CoronaVac", "Inactivated", "@3 Sinovac"); 

		assertEquals("Unrecognized vaccine: Covishield (Non Replicating Viral Vector; @1 Serum Institute of India)", v5.toString());
		assertEquals("Unrecognized vaccine: BBIBP-CorV (Inactivated; @2 Sinopharm)", v6.toString());
		assertEquals("Unrecognized vaccine: CoronaVac (Inactivated; @3 Sinovac)", v7.toString()); 
	}
	...
	@Test 
	public void mod_test_vaccine_distribution_01() {
		/* Create a distribution of some recognized vaccine. */
		Vaccine v1 = new Vaccine("mRNA-1273", "RNA", "Moderna");
		VaccineDistribution dist1 = new VaccineDistribution(v1, 13000);
		assertEquals("13000 doses of mRNA-1273 by Moderna", dist1.toString());

		/* Create a distribution of some unrecognized vaccine. */
		Vaccine v6 = new Vaccine("BBIBP-CorV", "Inactivated", "Sinopharm");
		VaccineDistribution dist2 = new VaccineDistribution(v6, 42000);
		assertEquals("42000 doses of BBIBP-CorV by Sinopharm", dist2.toString());
	}
	...
	public void mod_test_health_record_02() {
		 ...
		 */
		rec.addRecord(v1, "North York General Hospital", "April-25-2021");
		/* 
		 ...
		 */
		assertEquals("Number of doses Alan has received: 1 [Recognized vaccine: mRNA-1273 (RNA; Moderna) in North York General Hospital on April-25-2021]", rec.getVaccinationReceipt());
		
		/* Add a record for the patient's 2nd received dose. */
		rec.addRecord(v2, "Humber River Hospital", "July-30-2021");
		assertEquals("Number of doses Alan has received: 2 [Recognized vaccine: mRNA-1273 (RNA; Moderna) in North York General Hospital on April-25-2021; Recognized vaccine: BNT162b2 (RNA; Pfizer/BioNTech) in Humber River Hospital on July-30-2021]", rec.getVaccinationReceipt());
	...
	@Test
	public void mod_test_vaccination_site_01() {
		/* 
		 ...
		 */
		VaccinationSite vs = new VaccinationSite("#1 North York General Hospital", 10);
		
		assertEquals("#1 North York General Hospital has 0 available doses: <>", vs.toString());
	...
	@Test
	public void mod_test_vaccination_site_02a() {
		/* 
		 * Create a vaccination site with its name and
		 * 	the limit on the number of doses accumulated from the added distributions.
		 * For illustration, the limit is set with a small number.
		 */
		VaccinationSite vs = new VaccinationSite("York General Hospital", 10);
		...
		try {
			...
			assertEquals("York General Hospital has 3 available doses: <3 doses of Moderna>", vs.toString());
			
			vs.addDistribution(v2, 2); /* 1st distribution of Pfizer */
			assertEquals("York General Hospital has 5 available doses: <3 doses of Moderna, 2 doses of Pfizer/BioNTech>", vs.toString());
			
			vs.addDistribution(v1, 1); 
			assertEquals("York General Hospital has 6 available doses: <4 doses of Moderna, 2 doses of Pfizer/BioNTech>", vs.toString());
			
			vs.addDistribution(v3, 1); /* 1st distribution of AZ */
			assertEquals("York General Hospital has 7 available doses: <4 doses of Moderna, 2 doses of Pfizer/BioNTech, 1 doses of Oxford/AstraZeneca>", vs.toString());
			
			vs.addDistribution(v2, 3);
			assertEquals("York General Hospital has 10 available doses: <4 doses of Moderna, 5 doses of Pfizer/BioNTech, 1 doses of Oxford/AstraZeneca>", vs.toString());
		}
	...
	@Test
	public void mod_test_vaccination_site_02b() {
		/* 
		 * Create a vaccination site with its name and
		 * 	the limit on the number of doses accumulated from the added distributions.
		 * For illustration, the limit is set with a small number.
	...
	@Test
	public void mod_test_vaccination_site_02c() {
		/* 
		 * Create a vaccination site with its name and
		 * 	the limit on the number of doses accumulated from the added distributions.
		 * For illustration, the limit is set with a small number.
	...
	@Test
	public void mod_test_vaccination_site_02d() {
		/* 
		 * Create a vaccination site with its name and
		 * 	the limit on the number of doses accumulated from the added distributions.
		 * For illustration, the limit is set with a small number.
	...
	@Test
	public void mod_test_vaccination_site_03a() {
		/* 
		 * Create a vaccination site with its name and
		 * 	the limit on the number of doses accumulated from the added distributions.
		 * For illustration, the limit is set with a small number.
		...
		HealthRecord tom = new HealthRecord("Tommy", 5);
		...
		try {
			...
			assertEquals("Last vaccination appointment for Alan with #1 North York General Hospital succeeded", alan.getAppointmentStatus());
			vs.bookAppointment(mark);
			assertEquals("Last vaccination appointment for Mark with #1 North York General Hospital succeeded", mark.getAppointmentStatus());
			vs.bookAppointment(tom);
			assertEquals("Last vaccination appointment for Tommy with #1 North York General Hospital succeeded", tom.getAppointmentStatus());
		}
		...
		HealthRecord jim = new HealthRecord("Jimmmy", 5);
		try {
			...
			assertEquals("Last vaccination appointment for Jimmmy with #1 North York General Hospital failed", jim.getAppointmentStatus());
		}
	}
	
	@Test
	public void mod_test_vaccination_site_03b() {
		/* 
	 ...
	 */
	@Test
	public void mod_test_vaccination_site_04() {
		/* 
		 * Create a vaccination site with its name and
		 * 	the limit on the number of doses accumulated from the added distributions.
		 * For illustration, the limit is set with a small number.
		...
		try { 
			...
			vs.addDistribution(v2, 1); /* 1st distribution of Pfizer */
			vs.addDistribution(v1, 1);
			assertEquals("York General Hospital has 5 available doses: <2 doses of Oxford/AstraZeneca, 2 doses of Moderna, 1 doses of Pfizer/BioNTech>", vs.toString());
			
			HealthRecord alan = new HealthRecord("Alan", 5);
			HealthRecord mark = new HealthRecord("Mark", 5);
			HealthRecord tom = new HealthRecord("Tommy", 5);
			HealthRecord jim = new HealthRecord("Jimmy", 5);
			...
			/* updated site */
			assertEquals("York General Hospital has 2 available doses: <0 doses of Oxford/AstraZeneca, 1 doses of Moderna, 1 doses of Pfizer/BioNTech>", vs.toString());
			
			/* updated patients */
			assertEquals("Number of doses Alan has received: 1 [Recognized vaccine: AZD1222 (Non Replicating Viral Vector; Oxford/AstraZeneca) in York General Hospital on April-25-2021]", alan.getVaccinationReceipt());
			assertEquals("Number of doses Mark has received: 1 [Recognized vaccine: AZD1222 (Non Replicating Viral Vector; Oxford/AstraZeneca) in York General Hospital on April-25-2021]", mark.getVaccinationReceipt());
			assertEquals("Number of doses Tommy has received: 1 [Recognized vaccine: mRNA-1273 (RNA; Moderna) in York General Hospital on April-25-2021]", tom.getVaccinationReceipt());
			
			/* unchanged patients */
			assertEquals("Jimmy has not yet received any doses.", jim.getVaccinationReceipt());
			...
			vs.administer("August-30-2021");
			
			/* updated site */
			assertEquals("York General Hospital has 0 available doses: <0 doses of Oxford/AstraZeneca, 0 doses of Moderna, 0 doses of Pfizer/BioNTech>", vs.toString());
			
			/* updated patients */
			assertEquals("Number of doses Mark has received: 2 [Recognized vaccine: AZD1222 (Non Replicating Viral Vector; Oxford/AstraZeneca) in York General Hospital on April-25-2021; Recognized vaccine: mRNA-1273 (RNA; Moderna) in York General Hospital on August-30-2021]", mark.getVaccinationReceipt());
			assertEquals("Number of doses Jimmy has received: 1 [Recognized vaccine: BNT162b2 (RNA; Pfizer/BioNTech) in York General Hospital on August-30-2021]", jim.getVaccinationReceipt());
